...
Search.prototype.inverse = false;
Search.prototype.length1 = 0;
Search.prototype.maxlength2 = 0;
Search.prototype.sol = 999;
Search.prototype.solution = null;
Search.prototype.urfidx = 0;
Search.prototype.useSeparator = false;
Search.prototype.valid1 = 0;
Search.prototype.valid2 = 0;
...
/* SCRAMBLERS */
  ...
  // cp: 0,1,2,3 (DL)  4,5,6,7 (LL)
  // ep: 4,5,6,7 (DL)? 8,9,10,11 (LL)
  // co: 0,1,2,7 (DL)  3,4,5,6 (LL)
  // eo:               0,1,2,3 (LL)
  ...
  var getRandomElement = function(array, r) {
    return array[Math.floor((r || Math.random()) * array.length)];
  }

  var getCustomScramble = function(parameters) {
    if (parameters) {
      var r = Math.random();
